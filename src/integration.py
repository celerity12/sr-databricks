...
logger = logging.getLogger('sr-databricks')
...
def execute_spark_request(url):
    try:
        ...
        logger.info("sumit executing spark request ... " + url)
...
class Integration:
    ...
    def __init__(self, config):
        if 'spark' in config:
            logger.info("sumit reading spark config ... ") 
        ...
        if 'newrelic' in config:
            logger.info("sumit reading newrelic config ... ") 
        ...
        logger.info("sumit reading newrelic config newrelic_account_id ... " + newrelic_account_id) 
        newrelic_api_endpoint = newrelic_config['api_endpoint']
        logger.info("sumit reading newrelic config newrelic_api_endpoint ... " + newrelic_api_endpoint) 
        NewRelic.events_api_key = newrelic_config['api_key']
        logger.info("sumit reading newrelic config set_api_endpoint ... ") 
